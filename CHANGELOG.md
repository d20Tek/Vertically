...
- Switched the NuGet release workflow to trusted publishing, using OIDC to obtain a temporary
  nuget.org API key instead of a long-lived secret.
...
[0.9.2]: https://github.com/d20Tek/Vertically/releases/tag/v0.9.2
