...
/// <paramref name="Field"/> against their own model, coerce <paramref name="Value"/>, and apply the
...
public sealed record FilterExpression(string Field, FilterOperator Operator, object? Value) : FilterNode;
